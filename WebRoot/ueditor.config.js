    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain','wordpaster','netpaster', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
        ...
        ,labelMap:{
            'wordpaster':'粘贴图片或自动上传Word中的图片', 'netpaster':'自动上传远程服务器图片'
        }
        //webAppKey
